  ...
  window.RANKING_COMPARISON_DATA = Object.freeze({
    ...
    sources: Object.freeze({
      market: Object.freeze({
        ...
        shortName: "ADP",
        format: "Half PPR",
        coverage: "Top 120 local matches",
        note: "FantasyPros composite of Yahoo, Sleeper, and RTSports half-PPR ADP. This is market behavior, not an expert projection.",
      ...
      espn: Object.freeze({
        ...
        format: "PPR",
        coverage: "Top 300",
        note: "ESPN's dated PPR Top 300. League scoring is half PPR, so small WR/RB differences should be interpreted directionally.",
      ...
      fantasypros: Object.freeze({
        ...
        format: "Half PPR",
        coverage: "Top 120 local matches",
        note: "Consensus rank across current experts. It reduces single-analyst variance but can react slowly to genuinely new information.",
      ...
      sleeper: Object.freeze({
        ...
        url: "https://www.fantasypros.com/nfl/adp/half-point-ppr-overall.php",
        ranks: Object.freeze({"bijan-robinson":1,"jahmyr-gibbs":2,"ja-marr-chase":3,"puka-nacua":4,"christian-mccaffrey":5,"a-j-brown":20,"jaylen-waddle":49,"emeka-egbuka":45})
      }),
